[
    ...
    q{I'm not suffering from <Status>. I'm enjoying every minute of it!},
    ...
    'It was the best of times, it was the worst of times, it was the age of <Status>, it was the age of <Status>, . . .',
    "You want a tip?! Here's a tip, <Insult>: <!Rant>",
    'If the poor have no <Food>, then let them eat <Food>.',
    'My <.Loot> is too big.  My <!$0> is TOO BIG!',
    q{You've got a real <Status> problem, McFly. You're a <Verb>r! You remind me of your <Relationship> when <It> went here. <&$3> was a <$1>r, too.},
    ...
    'I saw the best minds of my generation destroyed by <Status>, starving <Adjective> <Adjective> . . .',
    'Hath not a <*$Opponent> eyes? Hath not a <$0> <Body_part>s, organs, dimensions, senses, affections, <Status>, fed with the same <Food>, hurt with the same <Loot>, subject to the same <Status>? If you prick us, do we not bleed <Soft_drink>?',
    ...
    'Somewhere near <!Location> a <!Monster> is suffering from <!Status> of the <!Body_part>!',
    'A can of <!Food>, <3d10+4> <!Animal>s, some LIVE <!Loot>, and a <!Loot>!',
    'My <!Vehicle> is <!Status>ing with a <!Monster>!!',
    '<^Status> is a real, serious condition! Go look it up yourself: http://en.wikipedia.org/wiki/<&,$0>',
    ...
    'Hold your ground, hold your ground! Sons of <^Location>, of <^Location>, my <Relationship>s! I see in your <Body_part>s the same fear that would take the heart of me. A day may come when the courage of <Monster>s fails, when we forsake our <Relationship>s and <Policy_violation>, but it is not <Date>. An hour of <Status> and <Status>, when the age of <$4>s comes crashing down! But it is not <$7>! <&$7> we fight! By all that you hold dear on this good Earth, I bid you <!Policy_compliance>, <!$4>s OF <!Location>!',
    ...
    '<&Vehicle> insurance: If you have no accidents - <1-9>0% money should be returned. Insure a <Monster>, but not <Its>/<Its> <$0>s. I promise to improve the <Status> problems.',
    ...
    "What langauge is this? Might be <Language> because I think I know all the other languages.",
